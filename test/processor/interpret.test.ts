...
describe('Interpretation Mode', () => {
  ...
  it('interpret square brackets', () => {
    const result = processor.interpret(`
      ...
      stroke-[#da5b66]
      text-[color:var(--color)] text-[angle:var(--angle)]
      ...
      text-[1.5rem] text-[#9254d2] text-[rgb(123,123,23)] text-[rgba(132,2,193,0.5)] text-[hsl(360,100%,50%)] text-[length:var(--font-size)]
