...
describe('Resolve Tests', () => {
  ...
  it('resolve static utilities', () => {
    expect(Object.keys(processor.resolveStaticUtilities(false)).length).toEqual(292);
    expect(Object.keys(processor.resolveStaticUtilities(true)).length).toEqual(298);
  });
