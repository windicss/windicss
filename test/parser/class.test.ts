...
describe("ClassParser", () => {
  it("parse", () => {
    ...
    expect(parser.parse()).toEqual([
      ...
      {
        raw:
          "md|-md: hover:  (bg-black-300 text-gray-200   text-lg dark:(bg-black-300 text-gray-200))",
